...
Dialog {
        ...
        ColumnLayout {
            ...
            Label {
                ...
                text: {
                    ...
                    if (controller.scanProgress === 0) return "Place finger on sensor to identify..."
                    ...
                    else if (controller.scanProgress < 100) return "Identifying against database..."
            ...
            RowLayout {
                ...
                Button {
                    Layout.fillWidth: true
                    Layout.preferredHeight: 50
                    text: resultText !== "" ? "Identify Again" : "Start"
                    ...
                    onClicked: {
                        resultText = ""
                        controller.identifyFingerprint()
                    }
                }
            }
        }
    ...
    Connections {
        ...
        function onOperationComplete(message) {
            if (identifyDialog.visible && (message.includes("Identified") || message.includes("Match found"))) {
                resultText = message
            }
        }
        function onOperationFailed(error) {
            if (identifyDialog.visible && error.includes("finger")) {
                resultText = error
            }
        }
    }
