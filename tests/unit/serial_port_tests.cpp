...
{
  std::vector<std::chrono::milliseconds> timeouts = {std::chrono::milliseconds{0}, std::chrono::milliseconds{1}, std::chrono::milliseconds{10}, std::chrono::milliseconds{100}, std::chrono::milliseconds{1000}};
